  ...
  return (
    ...
    <FormWrap>
      <FormBox onSubmit={handleSubmit}>
        <NameTag>
        <LabelTag style={{marginLeft:30}} htmlFor='id'>ID:</LabelTag>
        <Input
         id="id" width="300px"placeholder="아이디" type="password"value={newId} changeHandler={getNewId}/><Button size="mini">중복확인</Button>
        </NameTag>
        <NameTag>
